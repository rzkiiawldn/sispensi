<div class="page-wrapper bg-gra-02 p-t-130 p-b-100 font-poppins">
  <div class="wrapper wrapper--w680">
    <div class="card card-4">
      <div class="card-body">
        <h2 class="title">Pembuatan Surat Akte Kelahiran</h2>
        <ul class="nav nav-tabs mb-5">
          <li class="nav-item">
            <a class="nav-link active">Data Akun</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?= base_url('user/akte_kelahiran_lainnya') ?>">Lainnya</a>
          </li>
        </ul>
        <form method="POST" enctype="multipart/form-data" action="<?= base_url('user/add_akte') ?>">
          <div class="row row-space">
            ...
            <div class="col-12 mb-3">
              <label class="label">Surat Keterangan Lahir</label>
              <input type="file" class="form-control" required name="sk_lahir">
            </div><br>
          </div>
          <hr>
