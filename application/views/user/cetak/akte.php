...
<title><?= $judul; ?></title>
  ...
  <p style="font-size:14px;margin-top: 20px">Pada tanggal <?= date('d F Y', strtotime($data['tgl_permohonan'])); ?> Melakukan permohonan administrasi yaitu surat keterangan akte kelahiran , dan sudah melengkapi berkas-berkas yang diperlukan.</p>
